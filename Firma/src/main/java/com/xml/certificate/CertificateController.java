...
/*	private boolean checkCN(KeyStore ks, Enumeration<String> aliases) {
	...
	private boolean isCA(String alias, KeyStore ks) {
		try {
			...
			com.xml.certificate.Certificate cert = certificateService.findBySerialNumber(c.getSerialNumber().toString());
	...
	public void addCaSignedCertificate(@RequestBody BankCertificate bc,HttpSession httpSession) throws IOException, KeyStoreException,
		...
		if (ks.isKeyEntry(bc.getIssuerAlias())) {
			...
			certificateService.save(new com.xml.certificate.Certificate(bc.getSerialNumber(), false));
	...
	public com.xml.certificate.Certificate revokeCertificate(@PathVariable("serialNumber") String serialNumber) {
		com.xml.certificate.Certificate cer = certificateService.revoke(serialNumber);
		if(cer != null)
	...
	public com.xml.certificate.Certificate findBySerialNumber(@PathVariable("serialNumber") String serialNumber) {
